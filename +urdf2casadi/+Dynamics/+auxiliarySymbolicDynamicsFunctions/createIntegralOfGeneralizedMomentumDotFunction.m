function integralOfpHatDotFunction = createIntegralOfGeneralizedMomentumDotFunction(robotURDFModel)
...
dae = struct('x',p,'p',[q;qd;qdd;g;tau;r],'ode',pHatDot);
integralOfpHatDotFunction = integrator('F', 'idas', dae);
